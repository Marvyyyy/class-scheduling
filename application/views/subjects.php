              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="" name="subject" placeholder="Enter here...">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group row">
						<label for="inputEmail3" class="col-md-3 col-form-label">Subject Name</label>
						<div class="col-md-9">
							<input type="text" class="form-control" id="subject" name="subject" placeholder="Enter here...">
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $('#dataTableHover').DataTable(); // ID From dataTable with Hover
          ...
          "responsive": true,
					"ajax": {
						"url": "<?php echo base_url(); ?>subjects/fetch_alldata",
						"type": "POST",
						"dataSrc": ""
					},
					// dom: 'Bfrtip',
		...
		function edit(subj_id){
				$.ajax({
					...
					success:function(response)
					{
						...
						$('#subj_code').val(response.subj_code);
				...
				$.ajax({
					...
					success: function(response) {
						...
						if(rs.error === true) {
							...
							$('#subj_code_error').html(rs.subj_code_error);
