              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
						<select class="form-control" id="" name="role" style="width:100%;">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="" name="suffix" placeholder="Enter here...">
							<span class="text-danger" id="suffix_error"></span>
						</div>
					</div>
					<div class="form-group row">
						<label for="role" class="col-sm-3 col-form-label">Specialization</label>
						<div class="col-sm-9">
						<select class="select2-multiple form-control" id="" multiple name="subj[]" style="width:100%;" >
							<!-- <option disabled selected value="">--Select an option--</option> -->
							<?php
								foreach($subj as $row){
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<div class="form-group row">
						<label for="inputEmail3" class="col-md-3 col-form-label">Suffix</label>
						<div class="col-md-9">
							<input type="text" class="form-control" id="suffix" name="suffix" placeholder="Enter here...">
					...
					<div class="form-group row">
						<label for="role" class="col-sm-3 col-form-label">Specialization</label>
						<div class="col-sm-9">
						<select class="select2-multiple form-control" id="subj" name="subj[]" multiple style="width:100%;">
							<?php
								foreach($subj as $row){
								echo "<option value='".$row["subj_id"]."'>".$row["subj_code"]."</option>";
								}
      ...
      $('#dataTableHover').DataTable(); // ID From dataTable with Hover
		...
		function edit(fac_id){
				$.ajax({
					...
					success:function(response)
					{
						...
						if (response.with_spec == '1') {
							$('#subj').val(response.subj.subj_id).select2();
						}else{
						}
						$('#editModal').modal({
							backdrop:"static",
		...
		function deleteBtn(fac_id){
				$.ajax({
					...
					success:function(response)
					{
						$('#deleteID').val(response.data.fac_id);
						$('#deleteModal').modal({
							backdrop:"static",
							keyboard:false
						});
