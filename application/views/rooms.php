              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group row">
						<label for="inputEmail3" class="col-md-3 col-form-label">Room Name</label>
						<div class="col-md-9">
							<input type="text" class="form-control" id="" name="room" placeholder="Enter here...">
					...
					<!-- <div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="" name="subj_code" placeholder="Enter here...">
							<span class="text-danger" id="subj_code_error"></span>
						</div>
					</div> -->
					<!-- <div class="form-group row">
						<label for="role" class="col-sm-3 col-form-label">Specialization</label>
						<div class="col-sm-9">
						<select class="select2-single-placeholder form-control" id="" name="spec" style="width:100%;">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group row">
						<label for="inputEmail3" class="col-md-3 col-form-label">Room Name</label>
						<div class="col-md-9">
							<input type="text" class="form-control" id="room" name="room" placeholder="Enter here...">
					...
					<!-- <div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="subj_code" name="subj_code" placeholder="Enter here...">
							<span class="text-danger" id="subj_code_error_edit"></span>
						</div>
					</div> -->
					<!-- <div class="form-group row">
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $('#dataTableHover').DataTable(); // ID From dataTable with Hover
          ...
          "responsive": true,
					"ajax": {
						"url": "<?php echo base_url(); ?>rooms/fetch_alldata",
						"type": "POST",
						"dataSrc": ""
					},
					// dom: 'Bfrtip',
		...
		function edit(room_id){
				$.ajax({
					url: "<?php echo base_url('rooms/fetch_singledata/'); ?>",
					method:"POST",
					data:{idd:room_id},
					dataType:"json",
					success:function(response)
					{
						$('#editID').val(response.room_id);
						$('#room').val(response.room_name);
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#add_form').on('submit', function(e) {
				e.preventDefault();
				$.ajax({
					url: "<?php echo base_url()?>rooms/add_data",
					method: "post",
					data: $(this).serialize(),
					success: function(response) {
						...
						if(rs.error === true) {
							...
							// $('#room_code_error').html(rs.room_code_error);
			...
			$('#edit_form').on('submit',function(e){
					...
					$.ajax({
						...
						success: function(response) {
							...
							// $('#room_code_error_edit').html(rs.room_code_error);
							} else if(rs.error === false) {
			...
			$('#delete_form').on('submit',function(e){
					e.preventDefault();
					$.ajax({
						url: "<?php echo base_url()?>rooms/delete_data",
						method : "post",
						data : $(this).serialize(),
						success: function(response) {
